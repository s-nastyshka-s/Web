...
$returningChar = 0; // кол-во повторяющихся символов
...
foreach (count_chars($password) as $number)
{
    ...
    $number > 1 ? $returningChar = $returningChar + $number : null;
}
...
foreach (str_split($password , 1 ) as $char)
{
    ...
    // если $char буква в ниж. регистре, то $charUpper + 1
...
$strength = $strength - $returningChar;
